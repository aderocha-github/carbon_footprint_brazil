...
# Leitura dos dados
links2 <- read_xlsx("C:/Users/Ademir Rocha/Desktop/R_plot/sankey4.xlsx", sheet = "links")
nodes2 <- read_xlsx("C:/Users/Ademir Rocha/Desktop/R_plot/sankey4.xlsx", sheet = "nodes")
...
sankey <- htmlwidgets::onRender(
  ...
  function(el, x) {
    ...
    svg.append('text')
      ...
      .text('(c) Bovine meat and other meat products');
  }
  "
)
