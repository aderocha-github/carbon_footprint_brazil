...
# Leitura dos dados
links2 <- read_xlsx("C:/Users/Ademir Rocha/Desktop/R_plot/sankey2.xlsx", sheet = "links")
nodes2 <- read_xlsx("C:/Users/Ademir Rocha/Desktop/R_plot/sankey2.xlsx", sheet = "nodes")
