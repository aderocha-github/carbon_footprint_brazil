...
# Leitura dos dados
links2 <- read_xlsx("C:/Users/Ademir Rocha/Desktop/R_plot/sankey3.xlsx", sheet = "links")
nodes2 <- read_xlsx("C:/Users/Ademir Rocha/Desktop/R_plot/sankey3.xlsx", sheet = "nodes")
...
sankey <- htmlwidgets::onRender(
  ...
  function(el, x) {
    ...
    svg.append('text')
      ...
      .text('(b) Cattle and other live animals, animal products');
  }
  "
)
